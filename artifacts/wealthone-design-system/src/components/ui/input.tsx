  ...
  (
    ...
    return (
      <input
        ...
        className={cn('flex h-12 w-full rounded-md border border-input focus-visible:border-ring bg-card px-3.5 py-3 text-[15px] text-foreground shadow-sm transition-colors file:border-0 file:bg-transparent file:text-sm file:font-medium file:text-foreground placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background disabled:cursor-not-allowed disabled:opacity-50 lg:h-11 lg:py-2.5 lg:text-sm', className)}
        ref={setRefs}
        {...props}
      />
    );
