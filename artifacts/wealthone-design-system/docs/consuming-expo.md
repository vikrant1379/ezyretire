# Consuming ezyRetire Design System in Expo apps

Read `artifacts/wealthone-design-system/docs/AGENTS.md` first. React Native does
...
`artifacts/wealthone-design-system/docs/migrating-expo.md` before writing UI.
...
```tsx
import { tokens } from "@workspace/wealthone-design-system/tokens";
...
```tsx
import { nativeTheme } from "@workspace/wealthone-design-system/lib/native-theme";
import { useColors } from "@workspace/wealthone-design-system/hooks/use-colors";
import { useDesignSystemFonts } from "@workspace/wealthone-design-system/hooks/use-fonts";
```
...
```tsx
import { Badge } from "@workspace/wealthone-design-system/components/native/badge";
import { Button } from "@workspace/wealthone-design-system/components/native/button";
import { Card } from "@workspace/wealthone-design-system/components/native/card";
```
...
Import and render
`@workspace/wealthone-design-system/components/native/button`, then run Expo
