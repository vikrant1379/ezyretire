...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      classNames={{
        root: cn("mx-auto w-full max-w-[352px]", defaultClassNames.root),
        months: cn(
        ...
        dropdown_root: cn(
          "relative flex min-w-0 flex-1 items-center bg-transparent",
        ...
        day: cn(
          "group/day relative min-w-0 flex-1 select-none p-0 text-center [&_button]:h-11 [&_button]:min-w-0 [&_button]:w-full [&:first-child[data-selected=true]_button]:rounded-l-md [&:last-child[data-selected=true]_button]:rounded-r-md",
