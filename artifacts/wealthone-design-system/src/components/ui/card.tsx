...
const CardHeader = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(
  ({ className, ...props }, ref) => <div ref={ref} className="flex flex-col space-y-1.5 p-6 relative sm:flex-row sm:items-center sm:justify-between sm:pb-6 pb-[2px] gap-[5px] mb-[15px]" {...props} />,
);
