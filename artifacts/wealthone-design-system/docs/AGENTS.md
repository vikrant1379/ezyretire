...
workspace package (`@workspace/wealthone-design-system`): other artifacts depend
...
- `src/components/ui/` — the complete source-backed ezyRetire web catalog,
  including localized money input, date entry, forms, overlays, navigation,
  data display, feedback, and layout families, exported as `./components/*`.
- `docs/references/component-inventory.md` — source-backed family ranking,
  dependency-aware chunks, and implementation status. Read it before adding or
  migrating ezyRetire components.
- `docs/references/components/` — the retained build contracts for every
  cataloged family. Read the relevant family file before modifying a component.
...
- `src/preview/demos/<component>.tsx` — complete component-family stories. The
  Toast story also covers Toaster; keep these stories and the registry aligned
  with the final web component inventory.
...
`@workspace/wealthone-design-system/components/...`. Never use a `@/` alias inside
...
for `@workspace/wealthone-design-system` and renders mockups using this package's
theme and components.

## Consuming this package

Never copy token values, component source, hooks, or these docs into a consuming
artifact. Add `@workspace/wealthone-design-system` as a `workspace:*` dependency,
...
- Building or styling web UI: `artifacts/wealthone-design-system/docs/consuming-web.md`
- Building or styling Expo UI: `artifacts/wealthone-design-system/docs/consuming-expo.md`
- Building or styling a slide deck: `artifacts/wealthone-design-system/docs/consuming-slides.md`
- Replacing an existing or scaffolded web theme/component library:
  `artifacts/wealthone-design-system/docs/migrating-web.md`
- Replacing existing or scaffolded Expo theme/hooks/components:
  `artifacts/wealthone-design-system/docs/migrating-expo.md`
